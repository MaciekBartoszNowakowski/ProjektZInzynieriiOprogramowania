...
class ThesisAddView(CreateAPIView):
    """
    Endpoint for adding the authenticated supervisor's new thesis.
    ...
    def get_serializer_class(self):
        ...
        if user.role == Role.STUDENT:
            ...
            return SupervisorProfileSerializer
             ...
             raise NotImplementedError(f"Serializer for role '{user.role}' is not defined.")
    ...
    @extend_schema(
        request={
            ...
            'Coordinator/Admin': UserSerializer
        },
        responses={
            status.HTTP_200_OK: OpenApiResponse( 
                ...
                description='Updated user profile data based on role.' 
            ),
            ...
            status.HTTP_404_NOT_FOUND: OpenApiResponse(description='Profile not found for this user role.'),
        }
    )
