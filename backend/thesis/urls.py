...
from .views.thesis_views import ThesisAddView, AvailableThesisView, ThesisUpdateView, ThesisDeleteView, PromotorThesisView
...
urlpatterns = [
    ...
    path('my-topics/', PromotorThesisView.as_view(), name='promotor-thesis')
]