...
export default function SupervisorList() {
    ...
    return (
                ...
                <View style={styles.filterList}>
                    {departmentName.map((dept, index) => (
                        <TouchableOpacity
                            ...
                            style={[
                                styles.filterItem,
                                selectedDepartments.includes(dept.name) && styles.filterItemSelected,
                            ]}
                        >
                            <Text>{dept.name}</Text>
                        </TouchableOpacity>
        ...
        <View style={styles.defaultBox}>
            <TouchableOpacity onPress={() => setIsTagsOpen(prev => !prev)} style={styles.filterHeader}>
                <Text style={styles.titleTextBox}>
        ...
        <TouchableOpacity style={styles.applyFiltersButton} onPress={() => console.log('Button pressed!')}>
